...
const MyProfile = () => {
  ...
  return userData && (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      {
        isEdit
        ? <input className="bg-gray-50 txt-3xl font-medium max-w-60 mt-4" type="text" value={userData.name} onChange={(e)=> setUserData(prev=> ({...prev, name:e.target.value}))}/>
      ...
      <div className="mt-10">
        {
          isEdit
          ? <button className="border border-[#5f6FFF] px-8 py-2 rounded-full hover:bg-[#5f6FFF] hover:text-white transition-all duration-300" onClick={updateUserProfileData}>Save Information</button>
